	...
	private boolean acceptTestClass(Class<?> clazz) {
		...
		try {
			for (Method method : clazz.getMethods()) {
				// hugang, 同时支持Junit和TestNG的@Test
				// TestNG的@Test注解类 org.testng.annotations.Test ; JUnit4的@Test注解类org.junit.Test
				if ( (method.getAnnotation(Test.class) != null )  || ( method.getAnnotation(org.testng.annotations.Test.class) != null) ) {
					return true;
				}
			}
